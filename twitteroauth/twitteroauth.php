...
class TwitterOAuth {
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'imagetweet.com';
  ...
  function oAuthRequest($url, $method, $parameters, $upload = false) {
    ...
    default:
      return $this->http($request->get_normalized_http_url(), $method, $upload ? $request->get_parameters() : $request->to_postdata(), $upload ? $request->to_header().",Content-Transfer-Encoding: base64" : false);
    }
  }
